...
/**
 * This class was imported from PayPal's Adaptive Payments SDK
 * on their github page. In order for PayPal's Adaptive Payments
 * to work for our project, it required importing this code into our program.
 * @author 
 */
